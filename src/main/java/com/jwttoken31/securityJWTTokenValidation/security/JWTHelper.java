...
public class JWTHelper {
    ...
    private static final SecretKey secret= Keys.hmacShaKeyFor(Decoders.BASE64.decode(SecurityConstants.JWT_Secret));
    ...
    //2. Sign theJWT using the HS512 algorithm and secret key.
